      ...
      <div className='h-[500px] w-full bg-hero bg-cover bg-center bg-no-repeat text-white md:h-[700px]'>
        <div className='absolute inset-0 flex flex-col items-center justify-center gap-8 bg-black/60 p-8'>
          ...
          <div className='mt-10 flex'>
            <Link
              href='/blogs'
              className='rounded-full bg-brand-primary bg-opacity-95 px-10 py-4 text-lg font-medium text-white shadow-lg hover:bg-opacity-100 focus:shadow-sm transition-transform focus:scale-95'
            >
              Read the Blogs
            </Link>
          </div>
