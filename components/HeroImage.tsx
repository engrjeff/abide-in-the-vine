  ...
  return (
    <div className='relative'>
      <div className='h-[500px] w-full bg-hero bg-cover bg-center bg-no-repeat text-white md:h-[600px]'>
        <div className='absolute inset-0 flex flex-col items-center justify-center gap-8 bg-black/80 p-6'>
          <h1 className='text-center text-4xl font-extrabold md:text-6xl'>
            <span>Finding Joy in Christ,&nbsp;</span>
            <span>Having Christ as Joy</span>
          </h1>
          <p className='uppercase tracking-wider md:text-lg'>
