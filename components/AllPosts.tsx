...
const AllPosts = (props: AllPostsProps) => {
  ...
  const sortedPosts = _.orderBy(filteredPosts, ['createdAt'], [sortDirection]).slice(0, limit);

  return (
    <div>
      <div className='flex items-center mb-6'>
        <BlogsStatAndTimeFilter selectedFilter={selectedFilter} onChange={setSelectedFilter} />
