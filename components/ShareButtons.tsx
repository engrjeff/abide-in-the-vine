  ...
  return (
    <div className='h-12 flex items-center gap-x-4 mb-6'>
      <a
        ...
        className='text-abide-gray hover:text-[#1877f2] duration-200 transition-colors cursor-pointer'
      ...
      <a
        ...
        className='text-abide-gray hover:text-[#1da1f2] duration-200 transition-colors cursor-pointer'
