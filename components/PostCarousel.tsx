    ...
    <Card className='relative'>
      ...
      <div className='flex items-center justify-center gap-3 mt-3'>
        <button
          ...
          className='w-8 h-8 flex items-center justify-center bg-background text-muted border rounded-full transition-colors hover:text-accent hover:border-accent'
        >
