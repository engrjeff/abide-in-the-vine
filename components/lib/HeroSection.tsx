...
const HeroSection = () => {
  return (
    <section className='container flex flex-col items-center justify-center py-10 min-h-[80vh]'>
      <h1 className='max-w-2xl text-abide-dark dark:text-abide-light font-black text-[40px] md:text-6xl xl:text-7xl text-center mb-10'>
      ...
      <p className='max-w-xs md:max-w-md text-gray-800 text-lg md:text-xl text-center mb-5 relative font-sans dark:text-abide-light'>
        ...
        <span className='text-abide-main dark:text-abide-accent font-bold'>&nbsp; abide in Me</span>
        .
      </p>
